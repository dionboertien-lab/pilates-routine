...
export function renderOnboarding() {
  ...
  const data = state.onboardingData || { name: '', gender: 'female', goals: [], dailyMinutes: 15, daysPerWeek: 6, startDate: formatDate(new Date()), baseLevels: { core: 1, 'benen-billen': 1, 'rug-houding': 1 } };
